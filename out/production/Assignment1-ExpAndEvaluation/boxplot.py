...
# Load the CSV files
bubble_unc_times = pd.read_csv("BubbleSortUntilNoChange_String: 6.csv", header=None).T
bubble_needed_times = pd.read_csv("BubbleSortWhileNeeded_String: 6.csv", header=None).T
quick_times = pd.read_csv("QuickSortGPT_String: 6.csv", header=None).T
selection_times = pd.read_csv("SelectionSortGPT_String: 6.csv", header=None).T
...
# Load the CSV files
bubble_unc_times = pd.read_csv("BubbleSortUntilNoChange_String: 7.csv", header=None).T
bubble_needed_times = pd.read_csv("BubbleSortWhileNeeded_String: 7.csv", header=None).T
quick_times = pd.read_csv("QuickSortGPT_String: 7.csv", header=None).T
selection_times = pd.read_csv("SelectionSortGPT_String: 7.csv", header=None).T
...
# Load the CSV files
bubble_unc_times = pd.read_csv("BubbleSortUntilNoChange_String: 8.csv", header=None).T
bubble_needed_times = pd.read_csv("BubbleSortWhileNeeded_String: 8.csv", header=None).T
quick_times = pd.read_csv("QuickSortGPT_String: 8.csv", header=None).T
selection_times = pd.read_csv("SelectionSortGPT_String: 8.csv", header=None).T
